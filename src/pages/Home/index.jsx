      ...
      <SectionHome>
        ...
        <DivBanner>
          <DivTextsBanner>
            ...
            <div>
              <ButtonDefault onClick={() => history.push("/register")}>
                Registre-se
              </ButtonDefault>
              <button
        ...
        <SectionOurTeam>
          ...
          <div className="right">
            <div className="texts">
              ...
              <p>
                Em 2022, mais do que nunca, nós oferecemos ao consumidor uma
                solução segura e prática para que ele encontre ingredientes
        ...
        <SectionFoods>
          <div>
            ...
            <ButtonDefault onClick={() => history.push("/menu")}>
              Pratos
            </ButtonDefault>
          </div>
        </SectionFoods>
        <SectionCarousel>
          <div className="Carousel">
            ...
            <div className="texts">
              ...
              <div className="stars">
                {[1, 2, 3, 4, 5].map((index) => (
                  <img src={YellowStar} alt="star" key={index} />
                ))}
              </div>
            </div>
